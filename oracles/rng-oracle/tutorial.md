...
- **Transaction signing** via Capsule-Runtime API
...
# Run (uses mock Capsule-Runtime API)
...
4. ✅ Build off-chain enclave applications using Python and Capsule-Runtime API
