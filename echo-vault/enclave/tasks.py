...
class EchoTask:
    ...
    def __init__(self, capsule-runtime: Capsule-Runtime, chain: Chain):
        self.capsule-runtime = capsule-runtime
        self.chain = chain
        self.address = capsule-runtime.eth_address()
    ...
    def start(self):
        ...
        if not self._load_state():
            ...
            saved_block = self.capsule-runtime.s3_get("last_block")
            if saved_block:
    ...
    def _load_state(self) -> bool:
        ...
        try:
            data = self.capsule-runtime.s3_get("state.json")
            if not data:
                return False
    ...
    def _save_state(self, force: bool = False):
        ...
        try:
            ...
            if self.capsule-runtime.s3_put("state.json", data):
                self._dirty = False
    ...
    def _recover_state_from_s3_legacy(self):
        ...
        try:
            ...
            res = self.capsule-runtime.s3_list(prefix="echoes/")
            keys = res.get("keys", [])
            ...
            for key in keys:
                data = self.capsule-runtime.s3_get(key)
                if data:
                    try:
    ...
    def _echo_transfer(self, incoming_tx: Dict[str, Any], nonce: int) -> bool:
        ...
        try:
            ...
            signed_tx = self.capsule-runtime.sign_tx(tx_params)
